...
module Types
  class ConditionTermeInput < Types::BaseInputObject
    ...
    argument :operateur, String, "egal | different | superieur | superieur_ou_egal | inferieur | inferieur_ou_egal | inclut | exclut | dans_archipel | hors_archipel | dans_departement | hors_departement | dans_region | hors_region", required: true
