...
class TypesDeChampEditor::ChampComponent < ApplicationComponent
  ...
  def referentiel_filter_baserow_options
    ...
    fields = fetch_referentiel_filter_baserow_fields
  ...
  # pf: repli sur nil si Baserow est injoignable (cf. referentiel_filter_baserow_options)
  def fetch_referentiel_filter_baserow_fields
