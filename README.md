...
[Mes-Démarches](https://www.mes-demarches.gov.pf) is a fork of [demarches-simplifiees.fr](https://www.demarches-simplifiees.fr) adapted for French Polynesia's specific needs.

## How to contribute?
Mes-Démarches is a fork (a localized copy) of the démarches-simplifiées.fr website. 
Démarches-simplifiées.fr is a [free and open-source software](https://fr.wikipedia.org/wiki/Logiciel_libre) licensed under the AGPL.
