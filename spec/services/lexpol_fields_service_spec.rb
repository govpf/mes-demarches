...
RSpec.describe LexpolFieldsService do
  describe '.format_as_html_list' do
    ...
    it 'gère deux éléments correctement' do
      result = LexpolFieldsService.format_as_html_list(['Premier', 'Deuxième'])
      expect(result).to eq('<ul><li>Premier ;</li><li>Deuxième.</li></ul>')
    end
  end
end
