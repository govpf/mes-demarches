    ...
    scenario 'Setup as admin, fill in as user, view it as instructeur', js: true, vcr: true do
      ...
      VCR.use_cassette('referentiel/rnb_as_user') do
        ...
        perform_enqueued_jobs do
          ...
          # pf: notre composant génère display_usager_#{stable_id} pour éviter les collisions d'IDs
          page.find("button[aria-controls=display_usager_#{referentiel_stable_id}]").click
          within(".fr-collapse#display_usager_#{referentiel_stable_id}") do
