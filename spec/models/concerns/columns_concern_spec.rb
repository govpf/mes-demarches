    ...
    context 'when the procedure can have a SIRET number' do
      ...
      let(:expected) {
        [
          ...
          { label: 'Numéro TAHITI siège social', table: 'etablissement', column: 'entreprise_siret_siege_social', displayable: true, type: :text, filterable: true },
          { label: 'Date de création', table: 'etablissement', column: 'entreprise_date_creation', displayable: true, type: :date, filterable: true },
          { label: 'Numéro TAHITI', table: 'etablissement', column: 'siret', displayable: true, type: :text, filterable: true },
