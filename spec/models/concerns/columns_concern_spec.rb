    ...
    context 'when the procedure can have a SIRET number' do
      ...
      let(:expected) {
        [
          ...
          { label: 'Numéro TAHITI siège social', table: 'etablissement', column: 'entreprise_siret_siege_social', displayable: true, type: :text, scope: '', value_column: :value, filterable: true },
          ...
          { label: 'Numéro TAHITI', table: 'etablissement', column: 'siret', displayable: true, type: :text, scope: '', value_column: :value, filterable: true },
